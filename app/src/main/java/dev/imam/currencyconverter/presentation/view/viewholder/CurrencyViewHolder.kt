...
import dev.imam.currencyconverter.presentation.helper.CurrencyPayload
...
class CurrencyViewHolder(
    ...
    fun onBind(item: CurrencyModel, onTextChange:(text:String) -> Unit) {
        detachEventListener()
    ...
    fun onBind(item: CurrencyModel, fields: Set<*>?){
        fields?.forEach {
            when (it) {
